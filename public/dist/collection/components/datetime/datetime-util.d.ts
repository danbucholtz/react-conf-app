 ...
 */
export declare function convertToArrayOfStrings(input: any, type: string): string[];
/**
 * Use to convert a string of comma separated numbers or
 * an array of numbers, and clean up any user input
 */
export declare function convertToArrayOfNumbers(input: any, type: string): number[];
